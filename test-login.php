  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="userprofile.php"><?php echo "Welcome, $nick";?></a>
        </li>
		<li class="nav-item">
...
<div class="container1">
  ...
  <button type="button" class="btn btn-outline-primary" style="float: right;" onClick='document.location.href="top100.html"'> View All </button>
</section>
</div>
